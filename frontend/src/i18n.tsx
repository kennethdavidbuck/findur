...
const copy = {
  en: {
    ...
    consent: {
      ...
      retryAction: 'Try SnapTrade again',
      reconnectAction: 'Reconnect with SnapTrade',
      ...
      recovery: {
        denied: {
          ...
          body: 'You didn’t give Findur access. Nothing was changed, and you can try again whenever you’re ready.',
        },
        restart_required: {
          title: 'Let’s try that again.',
          body: 'We couldn’t finish signing you in. For your security, please start again.',
        },
        authorization_unavailable: {
          title: 'SnapTrade sign-in is unavailable right now.',
          body: 'Nothing was changed. Please try again later.',
        },
        initialization_failed: {
          title: 'We couldn’t open SnapTrade.',
          body: 'Nothing was changed. Please try again.',
        },
        invalid_request: {
          title: 'Let’s start again.',
          body: 'We couldn’t begin that sign-in safely. Nothing was changed.',
        },
        reauthorization_required: {
          title: 'Reconnect Findur to SnapTrade.',
          body: 'SnapTrade no longer gives Findur access. Your saved account choices are still here. Reconnect to keep them up to date.',
        },
      },
      back: 'Return home',
    ...
    authenticated: {
      ...
      inventory: {
        ...
        authorizationRepairHeading: 'Reconnect Findur to SnapTrade.',
        refreshErrorHeading: 'We couldn’t refresh your accounts.',
        states: {
          pending: 'Getting your accounts ready…',
          ready: 'Your accounts are ready.',
          empty: 'No investment accounts are ready to include.',
          disabled: 'SnapTrade cannot update these accounts until their brokerage connections are reconnected.',
          unauthorized: 'SnapTrade is no longer sharing updates with Findur. Your saved choices are still here. Reconnect to view and manage your accounts again.',
        ...
        connectionStates: { active: 'Active', disabled: 'Disconnected', unavailable: 'Unavailable' },
        connectionRepairHeading: (brokerage: string) => `The ${brokerage} connection is disconnected.`,
        connectionRepairBody: (brokerage: string) => `SnapTrade cannot send Findur fresh updates from ${brokerage}.`,
        connectionRepairAccounts: 'Affected accounts:',
        connectionRepairAction: (brokerage: string) => `Open SnapTrade to reconnect ${brokerage}`,
        ...
        inclusion: {
          setupEyebrow: 'Connection complete',
        ...
        manageInSnapTrade: 'Manage in SnapTrade',
        retry: 'Try again',
  ...
  fr: {
    ...
    consent: {
      ...
      retryAction: 'Réessayer avec SnapTrade',
      reconnectAction: 'Reconnecter avec SnapTrade',
      checking: 'Vérification de la connexion…',
      unavailable: 'La connexion est indisponible pour le moment. Réessayez plus tard.',
      recovery: {
        denied: {
          title: 'Vous gardez le contrôle.',
          body: 'Vous n’avez pas donné accès à Findur. Rien n’a changé et vous pourrez réessayer lorsque vous serez prêt.',
        },
        restart_required: {
          title: 'Réessayons.',
          body: 'Nous n’avons pas pu terminer la connexion. Pour votre sécurité, veuillez recommencer.',
        },
        authorization_unavailable: {
          title: 'La connexion à SnapTrade est indisponible pour le moment.',
          body: 'Rien n’a changé. Veuillez réessayer plus tard.',
        },
        initialization_failed: {
          title: 'Nous n’avons pas pu ouvrir SnapTrade.',
          body: 'Rien n’a changé. Veuillez réessayer.',
        },
        invalid_request: {
          title: 'Recommençons.',
          body: 'Nous n’avons pas pu démarrer cette connexion de façon sécuritaire. Rien n’a changé.',
        },
        reauthorization_required: {
          title: 'Reconnectez Findur à SnapTrade.',
          body: 'SnapTrade ne donne plus accès à Findur. Vos choix de comptes sont toujours enregistrés. Reconnectez-vous pour continuer à les mettre à jour.',
        },
      },
    ...
    authenticated: {
      ...
      inventory: {
        ...
        authorizationRepairHeading: 'Reconnectez Findur à SnapTrade.',
        refreshErrorHeading: 'Nous n’avons pas pu actualiser vos comptes.',
        states: {
          pending: 'Préparation de vos comptes…',
          ready: 'Vos comptes sont prêts.',
          empty: 'Aucun compte de placement n’est prêt à être inclus.',
          disabled: 'SnapTrade ne peut pas mettre ces comptes à jour tant que leurs connexions de courtage ne sont pas reconnectées.',
          unauthorized: 'SnapTrade ne transmet plus de mises à jour à Findur. Vos choix enregistrés sont toujours là. Reconnectez-vous pour voir et gérer vos comptes de nouveau.',
        ...
        connectionStates: { active: 'Active', disabled: 'Déconnectée', unavailable: 'Indisponible' },
        connectionRepairHeading: (brokerage: string) => `La connexion à ${brokerage} est déconnectée.`,
        connectionRepairBody: (brokerage: string) => `SnapTrade ne peut pas transmettre à Findur de nouvelles données de ${brokerage}.`,
        connectionRepairAccounts: 'Comptes touchés :',
        connectionRepairAction: (brokerage: string) => `Ouvrir SnapTrade pour reconnecter ${brokerage}`,
        ...
        inclusion: {
          setupEyebrow: 'Connexion réussie',
        ...
        manageInSnapTrade: 'Gérer dans SnapTrade',
        retry: 'Réessayer',
